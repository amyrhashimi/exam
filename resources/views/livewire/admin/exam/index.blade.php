                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button type="button" class="btn btn-primary btn-hover-scale" wire:click="create"> ساخت امتحان جدید </button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px">عنوان لاتین</th>
                                    <th class="min-w-125px">تعداد سولات</th>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                                                <div class="menu-item px-3">
                                                    <span class="menu-link px-3" wire:click="edit({{ $exam->id }})">ویرایش</span>
                                                </div>

                                                <div class="menu-item px-3">
                                                    <span class="menu-link px-3" wire:click="showQuestion({{ $exam->id }})">مشاهده سوالات</span>
                                                </div>
                                                
                                                <div class="menu-item px-3">
                                                    <span wire:click="destroy({{ $exam->id }})" class="menu-link px-3" data-kt-users-table-filter="delete_row">حذف</span>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
