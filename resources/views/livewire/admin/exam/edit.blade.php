                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="alert alert-danger d-flex align-items-center p-5 mb-10">
                            ...
                            <div class="d-flex flex-column">
                                <h4 class="mb-1 text-danger">امتحان شروع شده است.</h4>
                                <span>در صورتی که امتحان شروع شده باشد شما نمیتوانید تغییری ایجاد کنید.</span>
                            </div>
                        </div>
                        @endif
                        ...
                        <form wire:submit.prevent="update">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-solid mb-3 mb-lg-0 @error('title') border-danger @enderror" @if($exam->date < date('Y-m-d')) disabled @elseif ($exam->date == date('Y-m-d') AND $exam->time < date('H:i:s')) disabled @endif placeholder="عنوان" wire:model="title" />
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control form-control-solid mb-3 mb-lg-0 @error('slug') border-danger @enderror" @if($exam->date < date('Y-m-d')) disabled @elseif ($exam->date == date('Y-m-d') AND $exam->time < date('H:i:s')) disabled @endif placeholder="عنوان لاتین" wire:model="slug" />
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <select wire:model="lesson_id" class="form-select form-select-solid @error('lesson_id') border-danger @enderror" @if($exam->date < date('Y-m-d')) disabled @elseif ($exam->date == date('Y-m-d') AND $exam->time < date('H:i:s')) disabled @endif data-placeholder="درس خود را انتخاب کنید ...">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="date" class="form-control form-control-solid mb-3 mb-lg-0 @error('date') border-danger @enderror" @if($exam->date < date('Y-m-d')) disabled @elseif ($exam->date == date('Y-m-d') AND $exam->time < date('H:i:s')) disabled @endif placeholder="تاریخ شروع" wire:model.debounce.lazy="date" />
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
                                        ...
                                        <div class="col-md-6">
                                            <input type="time" class="form-control form-control-solid mb-3 mb-lg-0 @error('time') border-danger @enderror" @if($exam->date < date('Y-m-d')) disabled @elseif ($exam->date == date('Y-m-d') AND $exam->time < date('H:i:s')) disabled @endif placeholder="مدت امتحان" wire:model.debounce.lazy="time" />
                                            <div class="fv-plugins-message-container invalid-feedback"></div>
